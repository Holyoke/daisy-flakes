...
function SnowStorm() {
  ...
  this.flakeLeftOffset = -4;       // amount to subtract from edges of container
  this.flakeRightOffset = -4;      // amount to subtract from edges of container
  this.flakeWidth = 16;            // max pixel width for snow element
  this.flakeHeight = 16;           // max pixel height for snow element
  this.vMaxX = 3;                 // Maximum X velocity range for snow
  this.vMaxY = 2;                 // Maximum Y velocity range
